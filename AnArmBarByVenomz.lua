...
--CurrentHealth
        ...
        elseif (CurrentHealth/CurrentHealthMax) < 70/100 then
                InfoColour ("darkorange")
                Info ("hurting, ")
        elseif (CurrentHealth/CurrentHealthMax) < 90/100 then
                InfoColour ("darkgreen")
                Info ("scratched, ")
        elseif (CurrentHealth/CurrentHealthMax) < 100/100 then
                InfoColour ("green")
...
--		CurrentPosition ~= "Fighting" then
		CP ~= "1" then
                InfoColour ("black")
				Info (CurrentPosition)
--	elseif CurrentPosition == "Fighting" then 
--                InfoColour ("red")
--				Info (CurrentPosition)
	elseif CP == "1" then
                InfoColour ("red")
...
InfoColour ("black")
Info ("  ")
if CurrentPosition == "sleeping" then
		InfoColour ("darkorange")
	elseif CurrentPosition == "resting" then
		InfoColour ("darkblue")
	elseif CurrentPosition == "sitting" then
		InfoColour ("darkgreen")
	elseif CurrentPosition ~= "standing" then
		InfoColour ("firebrick")
	elseif CurrentPosition then
		InfoColour ("black")
end
...
--if CurrentPosition ~= "fighting" and
--	CurrentRiding == "none" then
--		InfoColour ("black")
--		Info ("You are ")
--end

if CurrentEncumbrance == "easily manageable" then
		InfoColour ("orange")
		Info ("You're lightly burdened.")
	elseif CurrentEncumbrance == "manageable" then
		InfoColour ("darkorange")
		Info ("You're burdened.")
	elseif CurrentEncumbrance == "heavy, but manageable" then
		InfoColour ("darkorange")
		Info ("You're heavily burdened.")
	elseif CurrentEncumbrance == "very heavy" then
		InfoColour ("darkred")
		Info ("You're very heavily burdened.")
	elseif CurrentEncumbrance == "VERY heavy" then
		InfoColour ("darkred")
		Info ("You're stooped under your load.")
	elseif CurrentEncumbrance == "unbelievably heavy" or
		CurrentEncumbrance == "extremely heavy" then
		InfoColour ("red")
		Info ("You're nearly unable to move with your load.")
--	elseif CurrentEncumbrance then
--		InfoColour ("black")
end
